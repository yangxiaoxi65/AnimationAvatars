...
class SMPLifyLoss(nn.Module):
    ...
    def forward(self, body_model_output, camera, gt_joints, joints_conf,
        ...
        joint_weights = joint_weights[:,:25] #CHANGED
        # # print("joint_weights", joint_weights)
        # # print("joints_conf", joints_conf)
        # padding = torch.zeros((1, 93))
        # joints_conf = torch.cat((joints_conf, padding), dim=1)
        ...
        projected_joints = projected_joints[:, :25, :]
