...
@torch.no_grad()
def refine(root, gender, keypoints_threshold=0.2, use_silhouette=False, downscale=1):
    ...
    body_model = smplx.SMPL("/home/tianhao/Projects/GaussianAvatar/assets/smpl_files/smpl", gender=gender)
...
if __name__ == "__main__":
    ...
    refine(args.data_dir, args.gender, args.keypoints_threshold, args.silhouette, args.downscale)
